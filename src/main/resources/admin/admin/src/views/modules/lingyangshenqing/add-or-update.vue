<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="宠物性别" prop="chongwuxingbie">
          <el-input v-model="ruleForm.chongwuxingbie" 
              placeholder="宠物性别" clearable  :readonly="ro.chongwuxingbie"></el-input>
        </el-form-item>
        <div v-else>
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="养宠经验" prop="yangchongjingyan">
          <el-select :disabled="ro.yangchongjingyan" v-model="ruleForm.yangchongjingyan" placeholder="请选择养宠经验">
            <el-option
        ...
        <div v-else>
          <el-form-item class="input" label="养宠经验" prop="yangchongjingyan">
	      <el-input v-model="ruleForm.yangchongjingyan"
                placeholder="养宠经验" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.jiatingdizhi = true;
          ...
          if(o=='yangchongjingyan'){
            this.ruleForm.yangchongjingyan = obj[o];
	    this.ro.yangchongjingyan = true;
            continue;
          }
          if(o=='beizhu'){
	...
	this.ruleForm.beizhu = this.ruleForm.beizhu.replace(reg,'../../../springbootf2308/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
