    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="感谢信" prop="ganxiexin">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.ganxiexin" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.ganxiexin" label="感谢信" prop="ganxiexin">
                    <span v-html="ruleForm.ganxiexin"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.shouji = true;
          ...
          if(o=='ganxiexin'){
            this.ruleForm.ganxiexin = obj[o];
	    this.ro.ganxiexin = true;
            continue;
          }
          if(o=='thumbsupnum'){
	...
	this.ruleForm.ganxiexin = this.ruleForm.ganxiexin.replace(reg,'../../../springbootf2308/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
