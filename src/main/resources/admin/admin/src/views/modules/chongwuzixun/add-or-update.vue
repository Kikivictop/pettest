      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="宠物品种" prop="chongwupinzhong">
          <el-input v-model="ruleForm.chongwupinzhong" 
              placeholder="宠物品种" clearable  :readonly="ro.chongwupinzhong"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="宠物品种" prop="chongwupinzhong">
              <el-input v-model="ruleForm.chongwupinzhong" 
                placeholder="宠物品种" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
...
export default {
  ...
  methods: {
	...
	this.ruleForm.xiangqing = this.ruleForm.xiangqing.replace(reg,'../../../springbootf2308/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
