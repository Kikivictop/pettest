<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="宠物状态" prop="chongwuzhuangtai">
          <el-select :disabled="ro.chongwuzhuangtai" v-model="ruleForm.chongwuzhuangtai" placeholder="请选择宠物状态">
            <el-option
        ...
        <div v-else>
          <el-form-item class="input" label="宠物状态" prop="chongwuzhuangtai">
	      <el-input v-model="ruleForm.chongwuzhuangtai"
                placeholder="宠物状态" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="宠物性情" prop="chongwuxingqing">
          <el-input v-model="ruleForm.chongwuxingqing" 
              placeholder="宠物性情" clearable  :readonly="ro.chongwuxingqing"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="宠物性情" prop="chongwuxingqing">
              <el-input v-model="ruleForm.chongwuxingqing" 
                placeholder="宠物性情" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="宠物爱好" prop="chongwuaihao">
          <el-input v-model="ruleForm.chongwuaihao" 
              placeholder="宠物爱好" clearable  :readonly="ro.chongwuaihao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="宠物爱好" prop="chongwuaihao">
              <el-input v-model="ruleForm.chongwuaihao" 
                placeholder="宠物爱好" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.chongwuxingqing = true;
          ...
          if(o=='chongwuaihao'){
            this.ruleForm.chongwuaihao = obj[o];
	    this.ro.chongwuaihao = true;
            continue;
          }
	...
	this.ruleForm.chongwuxiangqing = this.ruleForm.chongwuxiangqing.replace(reg,'../../../springbootf2308/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
