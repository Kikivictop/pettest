<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="宠物昵称" prop="chongwunicheng">
          <el-input v-model="ruleForm.chongwunicheng" 
              placeholder="宠物昵称" clearable  :readonly="ro.chongwunicheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="宠物昵称" prop="chongwunicheng">
              <el-input v-model="ruleForm.chongwunicheng" 
                placeholder="宠物昵称" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="24">  
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.chongwutupian" label="宠物图片" prop="chongwutupian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.chongwutupian.split(',')" :src="$base.url+item" width="100" height="100">
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          <el-form-item class="input" label="领养状态" prop="lingyangzhuangtai">
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="发现时间" prop="faxianshijian">
            <el-date-picker
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.faxianshijian" label="发现时间" prop="faxianshijian">
              <el-input v-model="ruleForm.faxianshijian" 
                placeholder="发现时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="发现地点" prop="faxiandidian">
          <el-input v-model="ruleForm.faxiandidian" 
              placeholder="发现地点" clearable  :readonly="ro.faxiandidian"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="发现地点" prop="faxiandidian">
              <el-input v-model="ruleForm.faxiandidian" 
                placeholder="发现地点" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="宠物特点" prop="chongwutedian">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.chongwutedian" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.chongwutedian" label="宠物特点" prop="chongwutedian">
                    <span v-html="ruleForm.chongwutedian"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.faxianshijian = true;
          ...
          if(o=='faxiandidian'){
            this.ruleForm.faxiandidian = obj[o];
	    this.ro.faxiandidian = true;
            continue;
          }
          if(o=='yonghuming'){
	    ...
	    this.ro.shoujihao = true;
          ...
          if(o=='chongwutedian'){
            this.ruleForm.chongwutedian = obj[o];
	    this.ro.chongwutedian = true;
            continue;
          }
        }
      }
	...
	this.ruleForm.chongwutedian = this.ruleForm.chongwutedian.replace(reg,'../../../springbootf2308/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `chongwuzhaoling/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.chongwuzhaolingCrossAddOrUpdateFlag = false;
						 this.parent.search();
